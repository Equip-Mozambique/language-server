/* global React */
// Tiny line-icon set — 16px viewBox, currentColor. Add to window.Icon.
...
const ICONS = {
  ...
  paint:       <><circle cx="8" cy="3" r="1.2" /><circle cx="3.5" cy="6.5" r="1" /><circle cx="3.5" cy="10.5" r="1" /><circle cx="12.5" cy="6.5" r="1" /><path d="M5 13.5C5 11.5 6 10 8 10C9.5 10 10 11 11 11C12 11 13 10.5 13 9C13 5.5 11 3 8 3" /></>,
  ...
  bolt_off:    <><path d="M8.5 1.5L5.5 5.5" /><path d="M10 7H13L8 14.5L8.3 11" /><path d="M1.5 1.5L14.5 14.5" /></>,
